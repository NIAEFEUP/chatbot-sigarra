...
// App Secret can be retrieved from the App Dashboard
  ...
  static receivedMessage (event) {
    ...
    if (messageText) {
      ...
      case "image":
        this.requiresServerURL(this.sendImageMessage, [senderID]);
        break;

      case "gif":
        this.requiresServerURL(this.sendGifMessage, [senderID]);
        break;

      case "audio":
        this.requiresServerURL(this.sendAudioMessage, [senderID]);
        break;

      case "video":
        this.requiresServerURL(this.sendVideoMessage, [senderID]);
        break;

      case "file":
        this.requiresServerURL(this.sendFileMessage, [senderID]);
        break;
      ...
      case "generic":
        this.requiresServerURL(this.sendGenericMessage, [senderID]);
        break;

      case "receipt":
        this.requiresServerURL(this.sendReceiptMessage, [senderID]);
        break;
      ...
      case "account linking":
        this.requiresServerURL(this.sendAccountLinking, [senderID]);
        break;
